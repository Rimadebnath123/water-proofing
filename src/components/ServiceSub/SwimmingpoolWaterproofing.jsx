...
const steps = [
    ...
    },
    {
        ...
        desc: "Allow the waterproofing membrane to cure completely, as per the manufacturer's instructions. This can take several days.Ponding Test: This is a mandatory and critical step. After the membrane has fully cured, fill the pool with water and leave it for a minimum of 48 to 72 hours",
        icon: <FaCheckCircle />,
    },
     {
        id: 6,
...
export default function BathroomWaterproofing() {
    return (
        <div className="font-sans">
            {/* Hero Section */}
            <section
                className="w-full h-[800px] sm:h-[500px] md:h-[600px] lg:h-[400px] text-white px-4 sm:px-8 text-center bg-cover bg-center relative"
                style={{
                ...
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <div className="md:pl-[6rem] lg:pl-[12rem]">
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">
                            Complete Swimming Pool <br /> Waterproofing Solutions
                        </h2>
